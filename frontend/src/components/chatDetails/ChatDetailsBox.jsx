    ...
    return (
        <>
            <div className="w-fit h-[60vh] p-2 flex flex-col gap-1.5 bg-slate-900">
                <div
                    className={`flex gap-2 items-center p-1 text-white rounded-md px-2 cursor-pointer ${detailView === "overview"
                            ? "bg-blue-950"
                            : "bg-slate-800"
                        }`}
                ...
                {selectedChat?.isGroupChat && (
                    <div
                        className={`flex gap-2 items-center p-1 text-white rounded-md px-2 cursor-pointer ${detailView === "members"
                                ? "bg-blue-950"
                                : "bg-slate-800"
                            }`}
                ...
                <div
                    className={`flex gap-2 items-center p-1 text-white rounded-md px-2 cursor-pointer ${detailView === "setting"
                            ? "bg-blue-950"
                            : "bg-slate-800"
                        }`}
